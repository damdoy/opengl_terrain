...
void main(){
   ...
   float rand_val = sin(frag_position.x*frag_position.z/30)+cos( (0.13-frag_position.x*frag_position.y) / 30 );
   ...
   color.rgb = vec3(0.1+rand_val/6, 0.4, 0.05)*light_intensity*reverse_dist_to_middle*sun_col;
}
